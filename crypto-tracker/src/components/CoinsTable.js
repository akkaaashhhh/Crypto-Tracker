...
const CoinsTable = () => {
    ...
    // const [searchListEmpty,setSearchListEmpty] = useState("true")
    
    // useEffect(()=>{setSearchListEmpty(handleSearch()?.length()===0)})
    ...
    return (
        <ThemeProvider theme={darkTheme}>
            <Container style={{textAlign : "Center"}}>
                ...
                <TextField label = "Enter the name of the CryptoCurrency to be searched" variant='outlined' style={{marginBottom: 20, width: "100%"}} onChange={(e)=>{setSearch(e.target.value)}}/>
                <TableContainer>
                    {
                        loading? (
